...
"  -r [num_requests]   Request download total (Default: 4)\n"           \
"  -p [server_port]    Server port (Default: 20801)\n"                         \
"  -s [server_addr]    Server address (Default: 127.0.0.1)\n"                   \
"  -t [nthreads]       Number of threads (Default 6)\n"                       \
...
/* COMMAND LINE OPTIONS ============================================= */
  ...
  while ((option_char = getopt_long(argc, argv, "t:p:n:hs:w:r:", gLongOptions, NULL)) != -1) {
    switch (option_char) {
      case 'h': // help
        Usage();
        exit(0);
